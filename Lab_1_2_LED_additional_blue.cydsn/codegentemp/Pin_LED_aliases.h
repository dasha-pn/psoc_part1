...
#define Pin_LED_LED1			(Pin_LED__LED1__PC)
#define Pin_LED_LED1_PS		(Pin_LED__LED1__PS)
#define Pin_LED_LED1_PC		(Pin_LED__LED1__PC)
#define Pin_LED_LED1_DR		(Pin_LED__LED1__DR)
#define Pin_LED_LED1_SHIFT	(Pin_LED__LED1__SHIFT)
#define Pin_LED_LED1_INTR	((uint16)((uint16)0x0003u << (Pin_LED__0__SHIFT*2u)))
