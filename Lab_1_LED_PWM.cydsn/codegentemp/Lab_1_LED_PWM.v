// ======================================================================
// Lab_1_LED_PWM.v generated from TopDesign.cysch
// 11/24/2025 at 16:20
...
module top ;
	...
	cy_clock_v1_0
		#(.id("fbb0a00b-7bd7-45fc-86d5-74dbad2b533f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("15096882-346b-4850-bece-6fd950ad54eb"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
